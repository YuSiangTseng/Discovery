...
@Component({
  selector: 'SearchEventsMenu',
  templateUrl: 'SearchEventsMenu.html'
})
export class SearchEventsMenuPage {

  private dummyDataToShowWithImgUrl = [];

  constructor(public platform: Platform ,public navCtrl: NavController, private storage: Storage) {
